...
**Estado**: SKIPPED  
**Evidencia**: `backend/app/error_responses.py` existe con:
- `ErrorCode` enum
...
**Estado**: SKIPPED  
**Evidencia**: `backend/app/config.py` tiene:
...
**Estado**: SKIPPED  
**Evidencia**: `backend/app/infrastructure/services/retry.py` existe con:
...
**Estado**: SKIPPED  
**Evidencia**: `backend/app/application/context_builder.py` tiene:
...
**Estado**: SKIPPED  
**Evidencia**: 
- `backend/app/infrastructure/db/pool.py` con `psycopg_pool`
- Transacciones en `postgres_document_repo.py`

### H7: Frontend API Facade + Tests
**Estado**: SKIPPED  
**Evidencia**: 
- `frontend/app/hooks/useRagAsk.ts` con `AbortController`
- `REQUEST_TIMEOUT_MS = 30_000`
- `frontend/__tests__/hooks/useRagAsk.test.tsx` con 7 tests

### H8: Docs CRC + Patterns
**Estado**: DONE  
**Archivos**: `doc/design/patterns.md` (creado)
