...
class TestConstantTimeCompare:
    ...
    def test_constant_time_compare_uses_hmac(self):
        ...
        for a, b, expected in test_cases:
            ...
            assert _constant_time_compare(a, b) == hmac.compare_digest(a.encode(), b.encode())
...
class TestParseKeysConfig:
    ...
    def test_parse_valid_json_config(self):
        ...
        with patch("app.config.get_settings") as mock_settings:
            mock_settings.return_value.api_keys_config = '{"key1": ["ask"], "key2": ["ingest"]}'
...
class TestRequireScopeErrors:
    ...
    async def test_key_without_scope_raises_403(self):
        ...
        with patch("app.auth.get_keys_config") as mock_config:
            mock_config.return_value = {"read-only-key": ["ask"]}  # Only has "ask" scope
